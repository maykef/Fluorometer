  ...
  if (Serial.available() > 0) {
    ...
    switch(led_brightness) {
       case '1':                     // Press 1
        ...
        analogWrite(LED_PIN_Blue_2, 250);  // Light off
      ...
      case '2': 
        ...
        delay(100000);
        analogWrite(LED_PIN_Blue, 212);  //  20% or 172 umoles 200
        analogWrite(LED_PIN_White, 175);  // 20% or 139 umoles 180
        analogWrite(LED_PIN_Red, 110);  //   60% or 396 umoles 120
        ...
        Serial.println("Done!");
        break;
      case '3':  // 110 microsecond pulse
        digitalWrite(LED_PIN_Blue, HIGH);
        delayMicroseconds(110);
        digitalWrite(LED_PIN_Blue, LOW);
        Serial.println("110 microsecond pulse sent");
        break;
      case '4':  // Two 2-microsecond pulses separated by 300 microseconds
        // First 2-microsecond pulse
        PORTD |= (1 << PD5);  // Set pin 5 (LED_PIN_Blue) high
        ...
        PORTD &= ~(1 << PD5);  // Set pin 5 (LED_PIN_Blue) low
        ...
        Serial.println("Two 2-microsecond pulses sent, separated by 300 microseconds");
        break;
    }
  }
}
